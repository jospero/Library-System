 ...
 */
public class StudentBorrowerListViewCell extends ListCell<StudentBorrowerTableModel> {
...
//        titleLabel.getStyleClass().add("author");
    ...
    @Override
    protected void updateItem(StudentBorrowerTableModel item, boolean empty) {
    ...
    private void addContent(StudentBorrowerTableModel item) {
        setText(null);
        configureLayout();
        configureBookView();
        configureTitle();
